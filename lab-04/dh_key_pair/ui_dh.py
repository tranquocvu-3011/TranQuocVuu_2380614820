...
class DHKeyApp(QMainWindow):
    def __init__(self):
        ...
        setup_group = QGroupBox("Server Parameter Generation")
        ...
        self.log_setup.setFixedHeight(100)
        ...
        bob_layout.addWidget(QLabel("Public Key (Shared with Alice):"))
        self.txt_bob_pub = QTextEdit()
        self.txt_bob_pub.setReadOnly(True)
        bob_layout.addWidget(self.txt_bob_pub)
        bob_layout.addWidget(QLabel("Shared Secret:"))
    ...
    def on_params_generated(self, parameters):
        ...
        self.log_setup.append("> Key pairs distributed successfully.")
